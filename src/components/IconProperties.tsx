...
import { useSession, type IconLayer } from '../store/session';
...
export function IconProperties({ layer }: { layer: IconLayer }) {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <div
          className="w-8 h-8 rounded border border-neutral-700 flex items-center justify-center shrink-0"
          style={{ color: layer.color }}
        >
          <DynamicIcon name={layer.name as IconName} size={18} />
        </div>
